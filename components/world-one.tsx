      ...
      <main>
        ...
        <section aria-labelledby="w1-rooms" className="px-6 py-20 md:py-28">
          ...
          <div className="mb-20 flex flex-col items-center gap-3 text-center md:mb-28">
            <h1
              id="w1-rooms"
              className="font-serif-two text-[24px] font-medium tracking-[0.3em] uppercase md:text-[28px]"
            >
              The Rooms
            </h1>
            ...
            {ROOM_CLASSES.slice(0, 4).map((room, i) => (
              ...
              >
                ...
                <div className="flex w-full flex-col items-center gap-5 text-center md:w-1/2">
                  ...
                  <h2 className="font-serif-two text-[26px] font-medium tracking-[0.16em] uppercase md:text-[30px]">
                    {room.name}
                  </h2>
        ...
        >
          <div className="mx-auto max-w-3xl">
            <div className="mb-16 flex items-baseline justify-center gap-4">
              ...
              <h2 id="w1-matcher" className="font-serif-two text-3xl font-medium md:text-4xl">
            ...
            <div className="flex flex-col gap-16 md:gap-20">
              {MATCHER_TRIPS.slice(0, 4).map((m, i) => (
                ...
                >
                  ...
                  >
                    <h3 className="font-serif-two text-xl font-medium text-balance md:text-2xl">{m.trip}</h3>
        ...
        <section aria-labelledby="w1-ledger" className="px-6 py-20 md:py-28">
          <div className="mx-auto max-w-xl">
            ...
            <h2
              id="w1-ledger"
              className="py-2 text-center font-serif-two text-[14px] font-medium tracking-[0.3em] uppercase"
            >
              The Ledger
            </h2>
